            ...
            chat_history=[
                {
                    "role": "SYSTEM",
                    "message": (
                        "You are a CIS professional a-levels/Igcse tutor, you only answer to questions related to a-levels/Igcse Physics/Maths. NEVER ANSWER IRRELEVANT QUESTIONS AND JUST ANSWER WITH ASK SMTH ELSE."
                    )
                }
            ]
        )
